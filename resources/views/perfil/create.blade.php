              ...
              <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group mt-4">
                      ...
                      <input type="text" name="title" class="form-control mt-2" placeholder="titulo" id="title" required>
                  </div>
                  <div class="form-group mt-4">
                      <label for="Descripcion">Descripcion : </label>
                      <input type="text" name="descripcion" class="form-control mt-2 py-5" placeholder="descripcion" id="descripcion" required>
                  </div>
                  <div class="form-group mt-4">
